...
export default function Toolbar({
  ...
  return (
    <>
      <div className="toolbar">
        <div className="toolbar-group">
          <button className="toolbar-btn" onClick={handleNew}
            onMouseEnter={(e) => showTooltip(e, '新建 (Ctrl+N)')}
          ...
          <button className="toolbar-btn" onClick={handleOpen}
            onMouseEnter={(e) => showTooltip(e, '打开 (Ctrl+O)')}
            onMouseLeave={hideTooltip}
          >
            <svg viewBox="0 0 24 24" width="18" height="18">
          ...
          <button className="toolbar-btn" onClick={handleSave}
            onMouseEnter={(e) => showTooltip(e, '保存 (Ctrl+S)')}
            onMouseLeave={hideTooltip}
          >
            <svg viewBox="0 0 24 24" width="18" height="18">
          ...
          <button className="toolbar-btn" onClick={handleSaveAs}
            onMouseEnter={(e) => showTooltip(e, '另存为 (Ctrl+Shift+S)')}
            onMouseLeave={hideTooltip}
          >
            <svg viewBox="0 0 24 24" width="18" height="18">
        ...
        <div className="toolbar-group">
          <button className="toolbar-btn" onClick={handleExportHTML}
            onMouseEnter={(e) => showTooltip(e, '导出 HTML')}
            onMouseLeave={hideTooltip}
          >
            <svg viewBox="0 0 24 24" width="18" height="18">
          ...
          <button className="toolbar-btn" onClick={handleExportPDF}
            onMouseEnter={(e) => showTooltip(e, '导出 PDF')}
            onMouseLeave={hideTooltip}
          >
            <svg viewBox="0 0 24 24" width="18" height="18">
        ...
        <div className="toolbar-group">
          <button className="toolbar-btn" onClick={toggleTheme}
            onMouseEnter={(e) => showTooltip(e, theme === 'light' ? '切换深色模式' : '切换浅色模式')}
            onMouseLeave={hideTooltip}
          >
            {theme === 'light' ? (
              <svg viewBox="0 0 24 24" width="18" height="18">
      ...
      {tooltip.visible && (
        <div
          className="toolbar-global-tooltip"
          style={{
            left: tooltip.x,
            top: tooltip.y,
